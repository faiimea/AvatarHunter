...
def load_data(dataset_path, resolution, dataset, pid_num, pid_shuffle, cache=True):
    ...
    for _label in sorted(list(os.listdir(dataset_path))):
        ...
        #print("--Debug--: _label = {}".format(_label))
    ...
    pid_list = np.load(pid_fname, allow_pickle=True)  # [Debug] in 20220707: https://blog.csdn.net/qq_19707521/article/details/109204013  
    train_list = pid_list[0]
    #print("--Debug-- train_list={}".format(train_list))
    test_list = pid_list[1]
    #test_list = ['m02', 'm07', 'm08', 'm12', 'm16', 'm35']
    print("--Debug-- test_list={}".format(test_list))
